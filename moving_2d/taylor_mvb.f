...
!       call col2(wx,fs_vmult,n)
!       call col2(wy,fs_vmult,n)
!       if (ndim.eq.3) call col2(wz,fs_vmult,n)
! 
! !     Spatially damp out the mesh velocity      
!       call col2(wx,dampw,ntot1)
!       call col2(wy,dampw,ntot1)
!       if (ndim.eq.3) call col2(wz,dampw,ntot1)
