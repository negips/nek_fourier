...
!      call outpost(tmp1,tmp2,tmp3,pr,tmp3,'tmp')
      ...
      if (istep.eq.0) then
        ...
        call rzero3(vxp(1,1),vyp(1,1),vzp(1,1),ntot1)
        call rzero3(vxp(1,2),vyp(1,2),vzp(1,2),ntot1)
       
        initc(1) = 'egvcouette0.f00001'
        call setics
        call copy3(tmp5,tmp6,tmp7,vx,vy,vz,ntot1)


        initc(1) = 'egvcouette0.f00002'
        call setics
        call copy3(tmp9,tmp10,tmp11,vx,vy,vz,ntot1)

        
        call copy3(vxp(1,1),vyp(1,1),vzp(1,1),tmp5,tmp6,tmp7,ntot1)
        call copy3(vxp(1,2),vyp(1,2),vzp(1,2),tmp9,tmp10,tmp11,ntot1)
