...
!        call outpost(vx,vy,vz,pr,t,'   ')
        ...
        call copy3(tmp1,tmp2,tmp3,vx,vy,t,ntot1)

        ifheat = .true.
        ifdg   = .true.
        initc(1) = 'egvpoiseuille0.f00016'
        call setics
        call copy(vz,t,ntot1)
        ifheat = .false.
        ifdg   = .false.

        call copy3(vxp(1,2),vyp(1,2),vzp(1,2),vx,vy,t,ntot1)
        call copy3(vxp(1,1),vyp(1,1),vzp(1,1),tmp1,tmp2,tmp3,ntot1)
